...
// If the users answer is correct then it will send the user to the next quesiton which in this case is 2_easy.html
    if (userAnswer === correctAnswer) {
      resultDiv.textContent = "Correct";
      resultDiv.style.color = "green";
      setTimeout(function () {
        window.location.href = "2_easy.html";
      }, 500);
    } else {
...
function hintFunction() {
  ...
  document.getElementById("hintDIV").textContent =
    "On the left of the screen is the Sydney Opera House";
