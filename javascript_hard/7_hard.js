...
// If the users answer is correct then it will send the user to the next quesiton which in this case is 8_hard.html
    if (userAnswer === correctAnswer) {
      resultDiv.textContent = "Correct";
      resultDiv.style.color = "green";
      setTimeout(function () {
        window.location.href = "8_hard.html";
      }, 500);
    } else {
