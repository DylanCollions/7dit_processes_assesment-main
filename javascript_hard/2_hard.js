...
// If the users answer is correct then it will send the user to the next quesiton which in this case is 3_hard.html
...
function hintFunction() {
  ...
  document.getElementById("hintDIV").textContent =
    "This Country flag uses White, Blue, Green, and Yellow";
